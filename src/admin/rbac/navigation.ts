...
export const ADMIN_NAV: readonly NavItem[] = [
  ...
  { to: "billing", label: "Billing", icon: Wallet, permission: "projects:view" },
  { to: "invoices", label: "Invoices", icon: FileText, permission: "projects:view" },
  { to: "portfolio", label: "Portfolio", icon: Images, permission: "projects:view" },
