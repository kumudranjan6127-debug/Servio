 ...
 * admin data layer); there is one billing document per client, so we take the
 * first match. The security rules ensure a client only ever receives the
 * document matching their own verified token email.
 *
